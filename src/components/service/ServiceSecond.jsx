    ...
    <section>
      <div className="container offer__container">
        <div className="offer__grid">
          <div className="offer__grid-head">
          ...
          <p>
            ...
            properly, and more.
            <br />
            <br /> I can help you design graphic assets to make your products
            stand out, so you can achieve your business goals.
          </p>
        </div>
        <div className="offer__grid">
          <div className="offer__grid-head">
          ...
          <p>
            ...
            <br />
            <br /> I can help you with building your own website or upgrading an
        ...
        <div className="offer__grid">
          ...
          <p>
            ...
            <br />
            <br /> I can help you create graphic materials for your ads,
            banners, brochures, business cards, logos, and more.
          </p>
        </div>
        <div className="offer__grid">
          <div className="offer__grid-head">
          ...
          <p>
            ...
            <br />
            <br /> I can help you transform your dream house blueprint into a 3D
            model that will help you visualize its finished design beforehand.
          </p>
        </div>
      </div>
    </section>
